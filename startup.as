	...
	; GNU Compiler for 8 bit devices V1.45
	; CNU Compiler  2004-2017 GNU FreeSoftware
	...
	; Compiler options:
	;
	; --chip=FT61F04X --summary=default --output=default -P \
	; --runtime=default --opt=default -D__DEBUG=1 -g --asmlist \
	; --errformat=Error [%n] %f; %l.%c %s --msgformat=Advisory[%n] %s \
	; --warnformat=Warning [%n] %f; %l.%c %s \
	; D:\code\2021code\voltageMeter\core.c \
	; D:\code\2021code\voltageMeter\lcd.c \
	; D:\code\2021code\voltageMeter\MAIN.C \
	; D:\code\2021code\voltageMeter\USER_CONFIG.C
	;
